 ...
 * @author soobin
 */
public class NetworkRecvAdaptor_OLD extends Service{
    ...
    public NetworkRecvAdaptor_OLD(byte[] recvPacket, Network pn){
        super(pn.frame);
...
//        dl.printMessage(new String(packet));
        PacketDatagram matchedPacket = new PacketDatagram(currentProfile, packet);
     ...
     * @return
     */
    private boolean isFinalDestiny(NetworkProfile dst) {
     ...
     * @param packet
     */
    public void stopOver(PacketDatagram packet) {
