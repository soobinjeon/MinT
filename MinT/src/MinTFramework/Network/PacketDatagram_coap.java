 ...
 */
public class PacketDatagram_coap {
     ...
     * @return 
     */
    public PacketDatagram_coap(int msgid, int h_ver, HEADER_TYPE h_type, int h_tkl, HEADER_CODE h_code,
    ...
    public PacketDatagram_coap(int h_ver, HEADER_TYPE h_type, int h_tkl, HEADER_CODE h_code,
            NetworkProfile src, NetworkProfile prev, NetworkProfile next, NetworkProfile dest, String msg) {
     ...
     * @param packet 
     */
    public PacketDatagram_coap(RecvMSG packet){
